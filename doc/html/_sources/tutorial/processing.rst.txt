...
is complete the resulting file is written back out as a GND/XML file.
...
processProtare takes a GND file as input. It also currently requires a LLNL-specific file called 'bdfls', which contains a database of
group boundaries and fluxes.

After translating an ENDF file into GND, you can do simple processing by:

::

        > python processProtare.py GND_file_name.xml --bdfls <path_to_fudge>/fudge/legacy/endl/bdfls
...
::
        ...
        > python processProtare.py GND_file_name.xml --bdfls <path_to_fudge>/fudge/legacy/endl/bdfls -t 300 -t 600 -t 900
                --temperatureUnit K 
...
::
        ...
        > python processProtare.py GND_file_name.xml --bdfls <path_to_fudge>/fudge/legacy/endl/bdfls --energyUnit eV
...
::
        ...
        > python processProtare.py GND_file_name.xml --bdfls <path_to_fudge>/fudge/legacy/endl/bdfls -t 300 -t 600
