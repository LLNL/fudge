...
<xsl:template match="reactionSuite">
    <html>   
        ...
        <body onLoad=" makeCollapsible(document.getElementById('reactions'));
            ...
            <p>
                XML files (such as GND) can be easily transformed into html for viewing online.
                This page contains an overview of the GND file that was automatically generated
