...
values1 = xrange( -3, 5 )
values2 = xrange( -30, 500 )
for i1 in xrange( 30 ) :
    check( random.choice( values1 ), [ float( random.choice( values1 ) ) for j1 in xrange( random.choice( values1 ) ) ] )
    check( random.choice( values2 ), [ float( random.choice( values2 ) ) for j1 in xrange( random.choice( values2 ) ) ] )
