...
class Times :
    ...
    All times are since :py:meth:`Times.reset` was called with the :py:method:`Times.reset` method calls.
    ...
    def __repr__( self ) :
        '''Calls :py:meth:`self.toString` with no arguments.'''

        return( self.toString( ) )

    def delta( self, reset = False ) :
        '''
        Returns time information since the last time :py:method:`Times.reset` was called as a dictionary.
        The dictionary as the keys 'user', 'sys', 'children', 'childrenSys' and 'wall'.

        :param reset:       If **True**, :py:method:`Times.reset` is called after the delta time is determined.
    ...
    def _delta_cpu( self, times, includeChildren = True, includeSystem = True ) :
        ...
        :param times:               The return instance from :py:method:`Times.delta`.
