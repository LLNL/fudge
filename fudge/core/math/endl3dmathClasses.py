...
"""
    ...
    def getValue( self, x, y ) :
        """Returns self's z value evaluated at (x, y). If x (y) is outside the range
        of self's x (y) domain then 0. is returned."""

        return endl3dmathmisc.interpolate_XY( self.data, x, y )
