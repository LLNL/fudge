...
NaEvaluation = reactionSuiteModule.ReactionSuite.readXML_file(os.path.join(TEST_DATA_PATH, 'n-011_Na_023.endf.gnds.xml'))
NaCovariance = covarianceSuiteModule.CovarianceSuite.readXML_file(os.path.join(TEST_DATA_PATH, 'n-011_Na_023.endf.gndsCov.xml'), reactionSuite=NaEvaluation)
